...
//-----------------------------------------------------------------------------------------------------------------------------//			
	...
	[System.NonSerializedAttribute] public float lastButtonTime   = 0.0f;// Last time the jump button was clicked down	
	[System.NonSerializedAttribute] public float lastGroundedTime = 0.0f;// Last time we were grounded
