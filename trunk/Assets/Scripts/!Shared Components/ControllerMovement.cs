...
//-----------------------------------------------------------------------------------------------------------------------------//			
	...
	[System.NonSerializedAttribute] public bool isMoving       = false;    // Is the user pressing the left or right movement keys?	[System.NonSerializedAttribute] public bool isMoving       = false; 
	[System.NonSerializedAttribute] public bool isClimbing     = false;	    // Is the user pressing the up or down movement keys?
	[System.NonSerializedAttribute] public bool isDead    = false;	    // Is the player dead?
